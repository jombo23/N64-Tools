...
enum    {AL_ADPCM_WAVE = 0, AL_RAW16_WAVE = 1, AL_VOX_WAVE=2, AL_MUSYX_WAVE=3, AL_SIGNED_RAW8=4, AL_SIGNED_RAW16=5, AL_MORT_WAVE=6, AL_WAV=7, AL_KOBE2_WAVE=8, AL_EXCITEBIKE_SAM=9, AL_EXCITEBIKE_SFX=10, AL_EXCITEBIKE_SNG=11, AL_FIGHTINGFORCE=12, AL_MADDENBNKB=13, AL_SOUTHPARKRALLY=14, AL_TWISTEDEDGESNOWBOARDING=15, AL_MADDEN64=16, AL_NAMCOMUSEUM=17, AL_MP3=18, AL_TOPGEARHYPERBIKE=19, AL_WDC=20, AL_ACCLAIM_DEAN=21, AL_UNSIGNED_RAW8=22, AL_TWISTEDEDGEMUSIC=23};
