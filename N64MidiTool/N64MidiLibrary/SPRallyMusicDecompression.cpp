...
CSPRallyMusicDecompression::CSPRallyMusicDecompression(void)
{
}
...
int CSPRallyMusicDecompression::FUN_00003424(unsigned char* inputBuffer, unsigned char* outputBuffer, unsigned long inputBufferOffset,__int64 outputBufferOffset,int numberEntries, int currentValue)
{
...
bool CSPRallyMusicDecompression::SaveProcessedWav(unsigned char* processedWavData, int processedWavDataLength, int waveType, int samplingRate, CString outputFilename)
{
...
//80076230
unsigned int CSPRallyMusicDecompression::CalculateHash(unsigned char* nameArray, unsigned long offset, unsigned long filetableMultiplier) // Calculate Hash
{
	//byte *offset
...
std::vector<SPRallySoundTableEntry> CSPRallyMusicDecompression::GetSoundTableEntries(unsigned char* ROM, int startSoundTable, int endSoundTable)
{
...
std::vector<SPRallyFileTableEntry> CSPRallyMusicDecompression::GetFileTableEntries(unsigned char* ROM, int fileTableStart, unsigned long& fileTableHashMultiplier)
{
...
CString CSPRallyMusicDecompression::GetSoundFileName(unsigned char* ROM, SPRallySoundTableEntry soundTableEntry)
{
...
SPRallyFileTableEntry CSPRallyMusicDecompression::GetFileEntry(unsigned char* ROM, CString nameROMStr, std::vector<SPRallyFileTableEntry> fileTable, unsigned long fileTableHashMultiplier, int& index)
{
...
SPRallyFileTableEntry CSPRallyMusicDecompression::GetSoundFile(unsigned char* ROM, SPRallySoundTableEntry soundTableEntry, std::vector<SPRallyFileTableEntry> fileTable, unsigned long fileTableHashMultiplier, CString& nameROMStr, int& index)
{
	SPRallyFileTableEntry spRallyFileTableEntry;
...
bool CSPRallyMusicDecompression::DecodeSoundFile(unsigned char* ROM, SPRallySoundTableEntry soundTableEntry, std::vector<SPRallyFileTableEntry> fileTable, unsigned long fileTableHashMultiplier, int fileTableStart, float samplingRateFloat, CString outputFile)
{
	CString nameROMStr;
	int index;
...
bool CSPRallyMusicDecompression::DecodeImpulseTracker(unsigned char* ROM, unsigned long fileTableHashMultiplier, int fileTableStart, unsigned long musicOffset, CString outputFile, int sampleTableOffset)
{
