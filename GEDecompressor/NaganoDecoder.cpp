...
//# Subfunction to return copylengths for comparison during sliding window.
 void CNaganoDecoder::samelength(int p, int& length, int& value, unsigned char* data, int sz)
 {
...
bool CNaganoDecoder::Compare(unsigned char* array, unsigned char* needle, int needleLen, int startIndex)
{
    // compare
...
int CNaganoDecoder::Find(unsigned char* array, unsigned char* needle, int needleLen, int startIndex, int sourceLength)
{
    int index;
 ...
 void CNaganoDecoder::copylength(int p, int& length, int& position, unsigned char* data, int sz)
 {
 ...
 std::vector<int> CNaganoDecoder::modella(int start, int length, int enclen, unsigned char* data, int sz)
{
	std::vector<int> ret;
	ret.resize(3);
...
void CNaganoDecoder::flushpush(int l, int p, unsigned char* data, unsigned char* out, int& outputPosition)
{
     if (l == 0)
         return;
...
void CNaganoDecoder::flushcopy(int l, int p, unsigned char* out, int& outputPosition)
{
     l -= 2;
...
void CNaganoDecoder::flushsame(int l, int c, unsigned char* out, int& outputPosition)
{
     l -= 2;
     if (c != 0)
	 {
