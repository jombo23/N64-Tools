...
{
public:
	DisassembledFileDetails()
	{

	}

	DisassembledFileDetails::DisassembledFileDetails(String^ filename, unsigned long startAddress, unsigned long binarySize, array<unsigned char>^ binary)
	{
